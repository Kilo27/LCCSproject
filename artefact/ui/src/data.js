...
'CSSEL':'Chicken Soup for the Soul Entertainment, Inc.',
...
'DMK':'DMK Pharmaceuticals Corporation',
...
'DWMC':'AdvisorShares Dorsey Wright Small Company ETF',
...
'EVMT':'Invesco Electric Vehicle Metals Commodity Strategy No K',
'EVO':'Evotec SE',
...
'NVD':'GraniteShares 1.5x Short NVDA Daily ETF',
...
'PDBA':'Invesco Agriculture Commodity Strategy No K',
...
'PEPLW':'PepperLime Health Acquisition Corporation',
...
'PMGMW':'Priveterra Acquisition Corp. II',
...
'PRVT':'Private Real Estate Strategy via Liquid REITs ETF',
...
'STRCW':'Sarcos Technology and Robotics Corporation',
...
'TETEU':'Technology & Telecommunication Acquisition Corporation',
...
'TSDD':'GraniteShares 1.5x Short TSLA Daily ETF',
...
'TSLR':'GraniteShares 1.75x Long TSLA Daily ETF',
...
'ZYXI':'Zynex, Inc.',
  ...
  const stockCodes = [
    ...
    "TTWO", "TMUS", "TSLA", "TXN", "TTD", "VRSK", "VRTX", "WBD", "WDAY", "XEL",
    "ZS"
];//Nasdaq 100 stock codes
  ...
  const handleInputChange = (e) => {
    ...
    if (value) {
      const filteredSuggestions = stockCodes.filter(code =>
  ...
  return (
    <div style={{ position: 'relative', display: 'inline-block' }} ref={inputRef}>
          ...
          {suggestions.map((suggestion, index) => (
            <li
              ...
              style={{
                padding: '10px',
                cursor: 'pointer',
                borderBottom: index !== suggestions.length - 1 ? '1px solid #847996' : 'none',
                backgroundColor: '#2c2f33',
                color: '#ffffff',
                transition: 'background 0.2s'
              }}
              onMouseEnter={(e) => (e.target.style.backgroundColor = '#847996')}
              onMouseLeave={(e) => (e.target.style.backgroundColor = '#2c2f33')}
            >
              {suggestion}
            </li>
          ))}
      ...
      <button
        ...
        onMouseLeave={(e) => (e.target.style.backgroundColor = '#847996')}
      >
        Submit
      </button>
    </div>
